...
internal class SendDeleteRequestUseCase(private val jsonRpcInteractor: JsonRpcInteractorInterface, private val storesRepository: StoresStorageRepository) {

    // https://github.com/WalletConnect/WalletConnectKotlinV2/issues/800 -> update params to have StoreKey
    suspend operator fun invoke(key: String, accountId: AccountId, store: Store, onSuccess: () -> Unit, onError: (Throwable) -> Unit) {
