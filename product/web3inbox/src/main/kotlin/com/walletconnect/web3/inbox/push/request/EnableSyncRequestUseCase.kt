...
) : NotifyRequestUseCase<Web3InboxParams.Request.Notify.EnableSyncParams>(proxyInteractor) {

    override fun invoke(rpc: Web3InboxRPC, params: Web3InboxParams.Request.Notify.EnableSyncParams) {
        notifyClient.enableSync(
            Notify.Params.EnableSync(params.account) { onSign(it).toNotify() },
