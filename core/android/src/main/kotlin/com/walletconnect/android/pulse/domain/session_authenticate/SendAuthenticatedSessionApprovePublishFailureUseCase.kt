package com.walletconnect.android.pulse.domain.session_authenticate
...
class SendAuthenticatedSessionApprovePublishFailureUseCase(
	...
	operator fun invoke() {
		super.invoke(
			Event(
				...
				props = Props.TraceProps.SessionAuthenticate.AuthenticatedSessionApprovePublishFailure()
			), SDKType.EVENTS
		)
	}
}