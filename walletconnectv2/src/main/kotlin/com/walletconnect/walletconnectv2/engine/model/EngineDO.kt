...
internal sealed class EngineDO {
    ...
    sealed class SessionUpdateNamespacesResponse : EngineDO(), SequenceLifecycle {
        data class Result(val topic: TopicVO, val namespaces: List<Namespace>) : SessionUpdateNamespacesResponse()
