...
private val polymorphicJsonAdapterFactory: PolymorphicJsonAdapterFactory<JsonRpcResponseVO> =
    PolymorphicJsonAdapterFactory.of(JsonRpcResponseVO::class.java, "type")
        .withSubtype(JsonRpcResponseVO.JsonRpcResult::class.java, "result")
        .withSubtype(JsonRpcResponseVO.JsonRpcError::class.java, "error")
