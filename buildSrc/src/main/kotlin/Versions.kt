...
//Latest versions
const val BOM_VERSION = "1.11.0"
const val FOUNDATION_VERSION = "1.10.0"
const val CORE_VERSION = "1.16.0"
const val SIGN_VERSION = "2.14.0"
const val AUTH_VERSION = "1.14.0"
...
val SAMPLE_VERSION_CODE = 100//BOM_VERSION.split(".").run { "${this[1]}${this[2]}" }.toInt()
const val SAMPLE_VERSION_NAME = BOM_VERSION
const val agpVersion = "8.0.1" // when changing, remember to change version in build.gradle.kts in buildSrc module
