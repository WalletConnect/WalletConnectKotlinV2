...
class GenerateApprovedNamespacesUtilsTest {
    ...
    fun `test if optional namespaces are satisfied when required namespaces are empty`() {
        ...
        val optional = mapOf("eip155" to Sign.Model.Namespace.Proposal(chains = listOf("eip155:1"), methods = listOf("eth_sendTransaction"), events = listOf("chainChanged", "accountChanged")))
        val supported = mapOf(
