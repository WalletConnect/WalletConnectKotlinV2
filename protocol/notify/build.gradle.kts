...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "PROD_GM_PROJECT_ID", "\"${requireNotNull(System.getenv("PROD_GM_PROJECT_ID"))}\"")
        buildConfigField("String", "PROD_GM_SECRET", "\"${requireNotNull(System.getenv("PROD_GM_SECRET"))}\"")
