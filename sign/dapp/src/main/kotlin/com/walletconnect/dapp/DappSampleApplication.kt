...
class DappSampleApplication : Application() {
    ...
    override fun onCreate() {
        ...
        CoreClient.initialize(relayServerUrl = serverUri, connectionType = ConnectionType.AUTOMATIC, application = this, appMetaData = Core.Model.AppMetaData(
            name = "Kotlin Dapp",
        ...
        val initString = Sign.Params.Init(core = CoreClient)
