...
//    releaseImplementation(platform("com.walletconnect:android-bom:1.1.0"))
    releaseImplementation("com.walletconnect:android-core:1.6.0-SNAPSHOT")
    releaseImplementation("com.walletconnect:sign:2.4.0-SNAPSHOT")
