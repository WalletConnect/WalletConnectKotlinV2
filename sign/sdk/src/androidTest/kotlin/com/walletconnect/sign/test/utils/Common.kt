...
val proposalNamespaces: Map<String, Sign.Model.Namespace.Proposal> = mapOf(
    sessionNamespaceKey to Sign.Model.Namespace.Proposal(sessionChains, sessionMethods, sessionEvents))


val sessionNamespaces: Map<String, Sign.Model.Namespace.Session> = mapOf(
    sessionNamespaceKey to Sign.Model.Namespace.Session(sessionChains, sessionAccounts, sessionMethods, sessionEvents)
)